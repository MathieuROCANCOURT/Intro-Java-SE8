...
public class GameMysteryNumber {
	private static boolean play(boolean start, Scanner sc) {
		String display;
		if (start) display = "Bonjour! Souhaitez-vous jouer [o/oui/n/non]?";
		else display = "Voulez-vous rejouer [o/oui/n/non]?";
	...
	public static void main(String[] args) {
		boolean first = true; Scanner sc = new Scanner(System.in);
		...
		while (play(first, sc)) {
			...
			while (genNumber != inputNumber) {
				if (nbTurn == 0) System.out.print("Saisir une valeur entre 1 et 100 inclus:");
				else if (genNumber > inputNumber) System.out.print("Saisir une valeur plus grande:");
				else System.out.print("Saisir une valeur plus petite:");
				try {
